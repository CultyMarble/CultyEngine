...
void ShadowEffect::Render(const RenderObject& renderObject)
{
	...
	const MathC::Matrix4 matView = mLightCamera.GetViewMatrix();
	const MathC::Matrix4 matProj = mLightCamera.GetProjectionMatrix();
...
void ShadowEffect::SetFocus(const MathC::Vector3& focusPosition)
{
...
void ShadowEffect::UpdateLightCamera()
{
	...
	const MathC::Vector3& direction = mDirectionalLight->direction;
