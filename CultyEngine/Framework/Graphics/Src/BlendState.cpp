...
namespace
{
	D3D11_BLEND GetSrcBlend(BlendState::BlendMode mode)
	{
		switch (mode)
		{
		case BlendState::BlendMode::Additive:			return D3D11_BLEND_SRC_ALPHA;
		case BlendState::BlendMode::AlphaBlend:			return D3D11_BLEND_SRC_ALPHA;
		case BlendState::BlendMode::AlphaPremultiplied:	return D3D11_BLEND_ONE;
		case BlendState::BlendMode::Opaque:				return D3D11_BLEND_ONE;
		default:
	...
	D3D11_BLEND GetDestBlend(BlendState::BlendMode mode)
	{
		switch (mode)
		{
		case BlendState::BlendMode::Additive:           return D3D11_BLEND_ONE;
		case BlendState::BlendMode::AlphaBlend:         return D3D11_BLEND_INV_SRC_ALPHA;
		case BlendState::BlendMode::AlphaPremultiplied: return D3D11_BLEND_INV_SRC_ALPHA;
		case BlendState::BlendMode::Opaque:             return D3D11_BLEND_ZERO;
		default:
			ASSERT(false, "BlendState: Unmapped BlendMode!");
			break;
		}
