...
protected:
    ...
    CultyEngine::Graphics::PostProcessingEffect mPostProcessingEffect;
    CultyEngine::Graphics::GaussianBlurEffect mGaussianBlurEffect;
    ...
    CultyEngine::Graphics::RenderTarget mBlurRenderTarget;
};